<?php
require(APPPATH.'libraries/cheddargetter/Client/Exception.php');
require(APPPATH.'libraries/cheddargetter/Response/Exception.php');
require(APPPATH.'libraries/cheddargetter/Response.php');
...
class CheddarGetter {
	 ...
	 */
	 function getPlans(array $filters = null) {
	 ...
	 * @throws CheddarGetter_Response_Exception
	 *//*
	 function editPlan($code, $id = null, array $data) {
		$this->_requireIdentifier($code, $id);
		return new CheddarGetter_Response(
			$this->request(
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function deletePlan($code, $id = null) {
		$this->_requireIdentifier($code, $id);
		return new CheddarGetter_Response(
			$this->request(
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function getCustomers(array $filters = null) {
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function getCustomer($code, $id = null) {
		$this->_requireIdentifier($code, $id);
		return new CheddarGetter_Response(
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function getAllCustomers(array $filters = null) {
		if ($this->getProductCode()) {
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function newCustomer(array $data) {
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function deleteCustomer($code, $id = null) {
		$this->_requireIdentifier($code, $id);
		return new CheddarGetter_Response(
			$this->request(
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function editSubscription($code, $id = null, array $data) {
		$this->_requireIdentifier($code, $id);
		return new CheddarGetter_Response(
			$this->request(
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function cancelSubscription($code, $id = null) {
		$this->_requireIdentifier($code, $id);
		return new CheddarGetter_Response(
			$this->request(
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function addItemQuantity($code, $id = null, array $data) {
		$this->_requireIdentifier($code, $id);
		return new CheddarGetter_Response(
			$this->request(
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function removeItemQuantity($code, $id = null, array $data) {
		$this->_requireIdentifier($code, $id);
		return new CheddarGetter_Response(
			$this->request(
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function setItemQuantity($code, $id = null, array $data) {
		$this->_requireIdentifier($code, $id);
		return new CheddarGetter_Response(
			$this->request(
	 ...
	 * @throws CheddarGetter_Response_Exception
	 */
	 function addCharge($code, $id = null, array $data) {
		$this->_requireIdentifier($code, $id);
		return new CheddarGetter_Response(
			$this->request(
